...
"""
    ...
    def cmd_migrate(self, dry_run: bool = True):
        ...
        migration_rules = {
            ...
            "201. Connect": self.config.folders["notes"],
            "300. Thinking": self.config.folders["notes"],
            "400. Reference": self.config.folders["books"],
        ...
        for md_file in files_to_migrate:
            ...
            if filename.startswith("d -") or filename.startswith("jrn -"):
                ...
                target_folder = self.config.folders["lectures"]
            elif filename.startswith(("c -", "n -", "fc -", "fyn -")):
                target_folder = self.config.folders["notes"]
            ...
            if not target_folder:
                ...
                if note_type == "daily":
                    ...
                    target_folder = self.config.folders["books"]
                elif note_type in ["concept", "note", "question"]:
                    target_folder = self.config.folders["notes"]
            ...
            if "Lectures" in target_folder or "📚" in target_folder:
